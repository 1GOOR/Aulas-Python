...
def janelaLogin():
    layout=[
        ...
        [sg.Image("img/1.png", background_color="#2F6073"), sg.Text("Login", size=7, background_color="#2F6073",text_color="#FFFFFF",font=" roboto 20" ),sg.Input(size=20,background_color="#FFFFFF",font=" roboto 15", key="-LOGIN-")],
        [sg.Image("img/2.png", background_color="#2F6073"), sg.Text("Senha", size=7, background_color="#2F6073",text_color="#FFFFFF", font=" roboto 20"),sg.Input(size=20,background_color="#FFFFFF",font=" roboto 15",password_char="*",key="-SENHA-" )],
...
def janelaCadastrarFuncionario():
    ...
    layout = [
        [sg.Image("img/logo.png",background_color="#2F6073"), sg.Push(background_color="#2F6073"),sg.Text("CADASTRAR FUNCIONARIO",background_color="#2F6073",font=("Helvetica ",17,"bold")),sg.Push(background_color="#2F6073")],
        [sg.HSep()],
        [sg.Text("Nome", background_color="#2F6073",font="arial 15"),
         sg.Input(size=(55, 50), background_color="#FFFFFF"), sg.Text("Nascimento",background_color="#2F6073", font="Helvetica 15"),
         sg.Input(size=20, background_color="#FFFFFF")]
    ]
