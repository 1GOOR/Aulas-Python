...
def janelaLogin():
    ...
    layout=[
        [sg.Push(background_color="#2F6073"),sg.Image("img/login.png.png",background_color="#2F6073"),sg.Push(background_color="#2F6073")],
        [sg.Image("img/1.png",background_color="#2F6073"),sg.Text("Login",size=7,background_color="#2F6073",text_color="#FFFFFF",font=fontTexto),sg.Input(size=20,background_color="#FFFFFF",font=" roboto 15", key="-LOGIN-")],
...
def janelaListarFuncionario():
    ...
    layout = [
        ...
        [sg.Text("Senha",size=10,background_color=cor_fundo, font=fontTexto),
         ...
         sg.Button("Deletar", font=fontTexto),
         sg.Push(background_color=cor_fundo), sg.Button("Atualizar", font=fontTexto, size=20),
         sg.Input(),
         sg.Button("Busacar", font=fontTexto)],
